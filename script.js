const translations = {
    pt: {
        ...
        spec1_title: 'Alojamento & Turismo',
        spec1_desc: 'Criamos sites imersivos para hotéis boutique e alojamentos locais, com galerias de alta qualidade e sistemas de reserva direta para atrair hóspedes de qualquer parte do mundo.',
        spec2_title: 'Plataformas Académicas',
        spec2_desc: 'Portais seguros e intuitivos para instituições e centros de estudos. Criamos soluções à medida para recolha de dados, inquéritos online e publicação de projetos, garantindo a organização e a privacidade exigidas.',
        spec3_title: 'Restauração & Retalho',
        spec3_desc: 'Menus digitais elegantes e montras virtuais que convertem visitantes em clientes. Quer venda pratos de assinatura ou produtos exclusivos, criamos a montra perfeita para a sua marca.',
        spec4_title: 'Escritórios & Consultoria',
        spec4_desc: 'Sites institucionais de alta segurança e sobriedade para escritórios de advogados, consultores e clínicas. Transmita credibilidade e autoridade desde o primeiro clique, com áreas reservadas e formulários seguros.',
        ...
        port3_desc: 'Plataforma de vendas online de vestuário de luxo, desenvolvida com foco em conversão, experiência mobile-first e design editorial.',
        port3_cta: 'Ver Estudo de Caso &rarr;',
        test_title: 'A Confiança dos Nossos Clientes',
        test_sub: 'O impacto do nosso trabalho medido por quem mais importa.',
        test1_feed: '"A C&D transformou por completo a nossa presença digital. O sistema de reservas direto que implementaram aumentou a nossa margem de lucro em semanas."',
        test1_client: 'Gestão Alojamento Local',
        test1_tag: 'Cliente Premium',
        test2_feed: '"Precisávamos de um portal para recolha de dados altamente seguro e organizado. A plataforma entregue superou todas as expectativas de rigor e privacidade."',
        test2_client: 'Departamento de Investigação',
        test2_tag: 'Cliente Académico',
        contact_title: 'Agende uma Consultoria de Projeto',
        contact_sub: 'Descreva-nos o seu projeto e receba uma proposta desenhada à sua medida.',
        form_name: 'O seu nome ou empresa',
        form_email: 'O seu endereço de email',
        form_select_placeholder: 'Qual é a sua área de negócio?',
        form_opt1: 'Alojamento & Turismo',
        form_opt2: 'Academia & Investigação',
        form_opt3: 'Restauração & Retalho',
        form_opt4: 'Serviços Corporativos',
        ...
        step1_desc: 'Tudo começa com uma análise profunda do seu negócio. Identificamos os seus desafios, estudamos o seu público-alvo e desenhamos a estrutura ideal para maximizar os resultados.',
        step2_title: 'Design & Desenvolvimento',
        step2_desc: 'Transformamos a estratégia numa experiência visual limpa. Criamos um design premium e programamos a sua plataforma com código limpo, garantindo rapidez e segurança.',
        step3_title: 'Lançamento & Evolução',
        step3_desc: 'Testamos cada detalhe antes de colocar o site no ar. Após o lançamento, oferecemos suporte contínuo e manutenção técnica para que o seu projeto digital esteja sempre atualizado.',
        faq_title: 'Perguntas Frequentes',
        faq_sub: 'Tudo o que precisa de saber antes de iniciarmos o seu projeto.',
        faq1_q: 'Quanto tempo demora a desenvolver um website?',
        faq1_a: 'O tempo de desenvolvimento varia consoante a complexidade. Projetos institucionais e menus digitais levam entre 2 a 3 semanas. Plataformas complexas ou portais de pesquisa podem exigir 4 a 6 semanas para garantir que todos os testes são rigorosamente cumpridos.',
    ...
    en: {
        ...
        spec1_title: 'Accommodation & Tourism',
        spec1_desc: 'We create immersive sites for boutique hotels and local accommodations, with high-quality galleries and direct booking systems to attract guests from anywhere in the world.',
        spec2_title: 'Academic Platforms',
        spec2_desc: 'Secure and intuitive portals for institutions and research centers. We create custom solutions for data collection, online surveys, and project publication, ensuring required organization and privacy.',
        spec3_title: 'Catering & Retail',
        spec3_desc: 'Elegant digital menus and virtual storefronts that convert visitors into customers. Whether you sell signature dishes or exclusive products, we create the perfect showcase for your brand.',
        spec4_title: 'Offices & Consulting',
        spec4_desc: 'High-security and sober institutional websites for law firms, consultants, and clinics. Convey credibility and authority from the first click, with reserved areas and secure forms.',
        portfolio_title: 'Recent Works',
        portfolio_sub: 'Explore some of the projects we developed with a focus on conversion and design.',
        port1_title: 'Interactive Platform',
        port1_desc: 'Immersive interface design with a floating interaction system and dynamic components for users.',
        port2_title: 'Signature Catering',
        port2_desc: 'Responsive digital showcase for a restaurant, focusing on gastronomic photography and readability.',
        port3_title: 'E-commerce & Fashion',
        port3_desc: 'Luxury clothing online sales platform, developed with a focus on conversion, mobile-first experience, and editorial design.',
        port3_cta: 'View Case Study &rarr;',
        test_title: "Our Clients' Trust",
        test_sub: 'The impact of our work measured by those who matter most.',
        test1_feed: '"C&D completely transformed our digital presence. The direct booking system they implemented increased our profit margin in weeks."',
        test1_client: 'Local Accommodation Management',
        test1_tag: 'Premium Client',
        test2_feed: '"We needed a highly secure and organized data collection portal. The delivered platform exceeded all expectations of rigor and privacy."',
        test2_client: 'Research Department',
        test2_tag: 'Academic Client',
        contact_title: 'Schedule a Project Consultancy',
        contact_sub: 'Describe your project to us and receive a proposal tailored to your needs.',
        form_name: 'Your name or company',
        form_email: 'Your email address',
        form_select_placeholder: 'What is your business area?',
        form_opt1: 'Accommodation & Tourism',
        form_opt2: 'Academia & Research',
        form_opt3: 'Catering & Retail',
        form_opt4: 'Corporate Services',
        ...
        step1_desc: 'It all starts with a deep analysis of your business. We identify your challenges, study your target audience, and design the ideal structure to maximize results.',
        step2_title: 'Design & Development',
        step2_desc: 'We transform strategy into a clean visual experience. We create a premium design and program your platform with clean code, ensuring speed and security.',
        step3_title: 'Launch & Evolution',
        step3_desc: 'We test every detail before putting the site online. After the launch, we offer continuous support and technical maintenance so your digital project is always up to date.',
        faq_title: 'Frequently Asked Questions',
        faq_sub: 'Everything you need to know before we start your project.',
        faq1_q: 'How long does it take to develop a website?',
        faq1_a: 'Development time varies depending on complexity. Institutional projects and digital menus take 2 to 3 weeks. Complex platforms or research portals may require 4 to 6 weeks to ensure all tests are rigorously met.',
        faq2_q: 'Does C&D guarantee data security and privacy on my site?',
        faq2_a: 'Absolutely. We design architectures with encryption certificates, rigorous access control, and in full legal compliance with data protection (GDPR), vital for your users\' trust.',
        faq3_q: 'Do you offer maintenance services after the launch?',
        faq3_a: 'Yes. We provide continuous maintenance plans to ensure your site is always fast, updated, and protected against new threats, so you can focus only on your business.',
        footer_tag: 'Premium Digital Design',
